...
public class LayerParser {
    ...
    public void fireChannelsLoaded(List<Channel> channels, int imageId) {
        if (handler != null) {
            handler.channelsLoaded(channels, imageId);
        }
    }
    ...
    public void parseImageSection(PsdInputStream stream, int imageId) throws IOException {
